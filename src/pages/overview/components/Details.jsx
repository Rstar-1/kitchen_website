    ...
    <Container version="v2" className="bg-white">
      <div className="w-full py-40">
        <div className="flex flex-wrap items-center gap-8 w-full">
          ...
          <p className="para-text cursor-pointer text-warning mt-3">Home</p>
          <svg
            viewBox="0 0 24 24"
            width="20"
            height="20"
          ...
          <p className="para-text text-warning mt-3">Product</p>
          <svg
            viewBox="0 0 24 24"
            width="20"
            height="20"
        ...
        <div className="grid-cols-2 sm-grid-cols-1 gap-12 mt-26 sm-mt-12">
          ...
          <div className="px-10 sm-px-1 sm-py-16 py-5">
            <p className="border-warning text-warning small-text font-400 w-max px-12 py-4 mb-20 sm-mb-14">
              {product?.stock} Stock
            </p>
